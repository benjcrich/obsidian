...
# Trinket
*Adventuring Gear*  
![](/2-Mechanics/CLI/items/img/trinket-phb.webp#right)  
...
| 46 | A dead [sprite](/2-Mechanics/CLI/bestiary/fey/sprite.md) inside a clear glass bottle |
...
| 81 | A purple handkerchief embroidered with the name of a powerful [archmage](/2-Mechanics/CLI/bestiary/humanoid/archmage.md) |
...
| 95 | A [petrified](/2-Mechanics/CLI/rules/conditions.md#petrified) mouse |
