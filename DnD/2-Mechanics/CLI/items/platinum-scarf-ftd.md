...
For 1 hour or until you dismiss it (no action required), the scale becomes a magic [light hammer](/2-Mechanics/CLI/items/light-hammer.md), which you or another creature can use. The weapon deals `2d4` radiant damage, instead of the bludgeoning damage normal for a light hammer. It deals an extra `2d4` radiant damage to chromatic dragons.
