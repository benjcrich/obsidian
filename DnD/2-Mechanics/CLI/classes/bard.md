...
- **Tools**: three [musical instruments](/2-Mechanics/CLI/items/musical-instrument.md) of your choice
...
- (a) a [rapier](/2-Mechanics/CLI/items/rapier.md), (b) a [longsword](/2-Mechanics/CLI/items/longsword.md), or (c) any simple weapon  
- (a) a [diplomat's pack](/2-Mechanics/CLI/items/diplomats-pack.md) or (b) an [entertainer's pack](/2-Mechanics/CLI/items/entertainers-pack.md)  
- (a) a [lute](/2-Mechanics/CLI/items/lute.md) or (b) any other musical instrument  
- [Leather armor](/2-Mechanics/CLI/items/leather-armor.md), and a [dagger](/2-Mechanics/CLI/items/dagger.md)  
...
- **Armor**: light
- **Weapons**: none
- **Tools**: one [musical instrument](/2-Mechanics/CLI/items/musical-instrument.md) of your choice
...
You can make a bard quickly by following these suggestions. First, Charisma should be your highest ability score, followed by Dexterity. Second, choose the [entertainer](/2-Mechanics/CLI/backgrounds/entertainer.md) background. Third, choose the [dancing lights](/2-Mechanics/CLI/spells/dancing-lights.md) and [vicious mockery](/2-Mechanics/CLI/spells/vicious-mockery.md) cantrips, along with the following 1st-level spells: [charm person](/2-Mechanics/CLI/spells/charm-person.md), [detect magic](/2-Mechanics/CLI/spells/detect-magic.md), [healing word](/2-Mechanics/CLI/spells/healing-word.md), and [thunderwave](/2-Mechanics/CLI/spells/thunderwave.md).
...
| 2 | A mithral [horn](/2-Mechanics/CLI/items/horn.md) made by elves |
| 3 | A zither made with drow spider silk |
| 4 | An orcish [drum](/2-Mechanics/CLI/items/drum.md) |
...
| 6 | When you sat on your [lute](/2-Mechanics/CLI/items/lute.md) by mistake during the final stanza of "Starlight Serenade" |
^embarrassment
...
For example, if you know the 1st-level spell [cure wounds](/2-Mechanics/CLI/spells/cure-wounds.md) and have a 1st-level and a 2nd-level spell slot available, you can cast [cure wounds](/2-Mechanics/CLI/spells/cure-wounds.md) using either slot.
...
You can use a [musical instrument](/2-Mechanics/CLI/items/musical-instrument.md) as a spellcasting focus for your bard spells.
...
*2nd-level bard [optional class features](/2-Mechanics/CLI/rules/variant-rules/optional-class-features-tce.md)*
...
*4th-level bard [optional class features](/2-Mechanics/CLI/rules/variant-rules/optional-class-features-tce.md)*
...
At 6th level, you gain the ability to use musical notes or words of power to disrupt mind-influencing effects. As an action, you can start a performance that lasts until the end of your next turn. During that time, you and any friendly creatures within 30 feet of you have advantage on saving throws against being [frightened](/2-Mechanics/CLI/rules/conditions.md#frightened) or [charmed](/2-Mechanics/CLI/rules/conditions.md#charmed). A creature must be able to hear you to gain this benefit. The performance ends early if you are [incapacitated](/2-Mechanics/CLI/rules/conditions.md#incapacitated) or silenced or if you voluntarily end it (no action required).
