...
|---------------|--------|
| 3rd | [ensnaring strike](/2-Mechanics/CLI/spells/ensnaring-strike.md), [speak with animals](/2-Mechanics/CLI/spells/speak-with-animals.md) |
| 5th | [moonbeam](/2-Mechanics/CLI/spells/moonbeam.md), [misty step](/2-Mechanics/CLI/spells/misty-step.md) |
| 9th | [plant growth](/2-Mechanics/CLI/spells/plant-growth.md), [protection from energy](/2-Mechanics/CLI/spells/protection-from-energy.md) |
| 13th | [ice storm](/2-Mechanics/CLI/spells/ice-storm.md), [stoneskin](/2-Mechanics/CLI/spells/stoneskin.md) |
| 17th | [commune with nature](/2-Mechanics/CLI/spells/commune-with-nature.md), [tree stride](/2-Mechanics/CLI/spells/tree-stride.md) |
^oath-of-the-ancients-spells
...
You can use your Channel Divinity to invoke primeval forces to ensnare a foe. As an action, you can cause spectral vines to spring up and reach for a creature within 10 feet of you that you can see. The creature must succeed on a Strength or Dexterity saving throw (its choice) or be [restrained](/2-Mechanics/CLI/rules/conditions.md#restrained). While [restrained](/2-Mechanics/CLI/rules/conditions.md#restrained) by the vines, the creature repeats the saving throw at the end of each of its turns. On a success, it frees itself and the vines vanish.
