...
- (a) a [quarterstaff](/2-Mechanics/CLI/items/quarterstaff.md) or (b) a [dagger](/2-Mechanics/CLI/items/dagger.md)  
- (a) a [component pouch](/2-Mechanics/CLI/items/component-pouch.md) or (b) an [arcane focus](/2-Mechanics/CLI/items/arcane-focus.md)  
- (a) a [scholar's pack](/2-Mechanics/CLI/items/scholars-pack.md) or (b) an [explorer's pack](/2-Mechanics/CLI/items/explorers-pack.md)  
- A [spellbook](/2-Mechanics/CLI/items/spellbook.md)  
...
You can make a wizard quickly by following these suggestions. First, Intelligence should be your highest ability score, followed by Constitution or Dexterity. If you plan to join the School of Enchantment, make Charisma your next-best score. Second, choose the [sage](/2-Mechanics/CLI/backgrounds/sage.md) background. Third, choose the [mage hand](/2-Mechanics/CLI/spells/mage-hand.md), [light](/2-Mechanics/CLI/spells/light.md), and [ray of frost](/2-Mechanics/CLI/spells/ray-of-frost.md) cantrips, along with the following 1st-level spells for your spellbook: [burning hands](/2-Mechanics/CLI/spells/burning-hands.md), [charm person](/2-Mechanics/CLI/spells/charm-person.md), [feather fall](/2-Mechanics/CLI/spells/feather-fall.md), [mage armor](/2-Mechanics/CLI/spells/mage-armor.md), [magic missile](/2-Mechanics/CLI/spells/magic-missile.md), and [sleep](/2-Mechanics/CLI/spells/sleep.md).
...
For example, if you're a 3rd-level wizard, you have four 1st-level and two 2nd-level spell slots. With an Intelligence of 16, your list of prepared spells can include six spells of 1st or 2nd level, in any combination, chosen from your spellbook. If you prepare the 1st-level spell [magic missile](/2-Mechanics/CLI/spells/magic-missile.md), you can cast it using a 1st-level or a 2nd-level slot. Casting the spell doesn't remove it from your list of prepared spells.
...
You can use an [arcane focus](/2-Mechanics/CLI/items/arcane-focus.md) as a spellcasting focus for your wizard spells.
...
> 
> **Copying from a Spell Scroll.** A wizard spell on a spell scroll can be copied just as spells in spellbooks can be copied. When you copy a spell from a spell scroll, you must succeed on an Intelligence ([Arcana](/2-Mechanics/CLI/rules/skills.md#Arcana)) check with a DC equal to 10 + the spell's level. If the check succeeds, the spell is successfully copied. Whether the check succeeds or fails, the spell scroll is destroyed.
> 
...
*3rd-level wizard [optional class features](/2-Mechanics/CLI/rules/variant-rules/optional-class-features-tce.md)*
