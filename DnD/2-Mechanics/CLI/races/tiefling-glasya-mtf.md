...
You know the [minor illusion](/2-Mechanics/CLI/spells/minor-illusion.md) cantrip. When you reach 3rd level, you can cast the [disguise self](/2-Mechanics/CLI/spells/disguise-self.md) spell once with this trait and regain the ability to do so when you finish a long rest. When you reach 5th level, you can cast the [invisibility](/2-Mechanics/CLI/spells/invisibility.md) spell once with this trait and regain the ability to do so when you finish a long rest. Charisma is your spellcasting ability for these spells.
