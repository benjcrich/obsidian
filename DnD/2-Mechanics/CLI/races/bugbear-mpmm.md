...
SourceType: "Race"
NoteIcon: race
BookSource: Mordenkainen Presents: Monsters of the Multiverse p. 8
---
# Bugbear
*Source: Mordenkainen Presents: Monsters of the Multiverse p. 8*  
![](/2-Mechanics/CLI/races/img/bugbear.webp#right)  
...
You are proficient in the [Stealth](/2-Mechanics/CLI/rules/skills.md#Stealth) skill. In addition, without squeezing, you can move through and stop in a space large enough for a Small creature.
