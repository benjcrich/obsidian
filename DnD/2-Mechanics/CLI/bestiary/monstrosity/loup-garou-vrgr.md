...
- "desc": "Melee Weapon Attack: +9 to hit, reach 5 ft., one target. Hit: 11 (2d6\
    \ + 4) slashing damage. If the target is a creature, it must succeed on a DC\
    \ 17 Strength saving throw or be knocked [prone](/2-Mechanics/CLI/rules/conditions.md#prone)."
...
"source":
- "VRGR"
"image": "/2-Mechanics/CLI/bestiary/monstrosity/token/loup-garou.png"
```
^statblock
