...
- "desc": "The cerberus exhales a 15-foot cone of molten rock. Each creature in the\
    ...
    \ by the hardening rock. A creature can make a DC 12 Strength (Athletics) check\
    \ as an action, freeing itself or a creature within reach from the rock on a success.\
    \ The rock has AC 17 and 10 hit points, and it is immune to fire, poison, and\
    \ psychic damage."
  "name": "Breath Weapon (Recharge 5-6)"
"source":
- "MOT"
"image": "/2-Mechanics/CLI/bestiary/monstrosity/token/two-headed-cerberus.png"
```
^statblock
