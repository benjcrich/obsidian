...
- "desc": "Melee Weapon Attack: +7 to hit, reach 5 ft., one creature. Hit: 7 (1d6\
    \ + 4) piercing damage, and if the target is a creature, it is [grappled](/2-Mechanics/CLI/rules/conditions.md#grappled)\
    \ (escape DC 15)."
  "name": "Tentacles"
...
"source":
- "VRGR"
"image": "/2-Mechanics/CLI/bestiary/undead/token/vampiric-mind-flayer.png"
```
^statblock
