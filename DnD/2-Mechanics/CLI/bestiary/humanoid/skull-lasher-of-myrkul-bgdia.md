...
- "desc": "Ranged Spell Attack: +5 to hit, range 60 ft., one creature. Hit: 9\
    \ (2d8) poison damage, and the target must succeed on a DC 13 Constitution saving\
...
"source":
- "BGDIA"
"image": "/2-Mechanics/CLI/bestiary/humanoid/token/skull-lasher-of-myrkul.png"
```
^statblock
