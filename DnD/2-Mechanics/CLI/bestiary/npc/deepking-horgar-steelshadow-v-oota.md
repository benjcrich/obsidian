...
- "desc": "Melee Weapon Attack: +8 to hit, reach 5 ft., one target. Hit: 10 (1d8\
    \ + 6) bludgeoning damage, or 11 (1d10 + 6) bludgeoning damage if used with\
    \ two hands. While Horgar is enlarged, the damage increases to 15 (2d8 + 6)\
    \ or 17 (2d10 + 6) bludgeoning damage, respectively."
  "name": "+2 Warhammer"
...
"source":
- "OotA"
"image": "/2-Mechanics/CLI/bestiary/npc/token/deepking-horgar-steelshadow-v.png"
```
^statblock
