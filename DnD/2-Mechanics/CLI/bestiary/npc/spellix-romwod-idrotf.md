...
- "desc": "Spellix has advantage on all Intelligence, Wisdom, and Charisma saving\
  ...
  "name": "Gnome Cunning"
"actions":
- "desc": "Melee Spell Attack: +5 to hit (with advantage on the attack roll if the\
    \ target is wearing armor made of metal), reach 5 ft., one creature. Hit: 4\
    \ (1d8) lightning damage, and the target can't take reactions until the start\
    \ of its next turn."
  "name": "Shocking Grasp (Cantrip)"
- "desc": "Ranged Spell Attack: +5 to hit, range 120 ft., one target. Hit: 5 (1d10)\
    \ fire damage. A flammable object hit by this spell ignites if it isn't being\
    \ worn or carried."
  "name": "Fire Bolt (Cantrip)"
"source":
- "IDRotF"
"image": "/2-Mechanics/CLI/bestiary/npc/token/spellix-romwod.png"
```
^statblock
