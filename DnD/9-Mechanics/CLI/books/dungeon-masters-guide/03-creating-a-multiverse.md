...
The [gate](/2-Mechanics/CLI/spells/gate.md) spell is powerful, but not infallible. A deity, demon lord, or other powerful entity can prevent such a portal from opening within its dominion.
...
Traveling through the Astral Plane by means of the [astral projection](/2-Mechanics/CLI/spells/astral-projection.md) spell involves projecting one's consciousness there, usually in search of a gateway to an Outer Plane to visit. Since the Outer Planes are as much spiritual states of being as they are physical places, this allows a character to manifest in an Outer Plane as if he or she had physically traveled there, but as in a dream.
...
![Astral Color Pools](/2-Mechanics/CLI/tables/astral-color-pools.md)
...
![Psychic Wind](/2-Mechanics/CLI/tables/psychic-wind.md)
...
![Deep Ethereal; Ethereal Curtains](/2-Mechanics/CLI/tables/deep-ethereal-ethereal-curtains.md)
...
An ether cyclone is a serpentine column that spins through the plane. The cyclone appears abruptly, distorting and uprooting ethereal forms in its path and carrying the debris for leagues. Travelers with a passive Wisdom ([Perception](/2-Mechanics/CLI/rules/skills.md#Perception)) score of 15 or more receive `1d4` rounds of warning: a deep hum in the ethereal matter.
...
![Ether Cyclones](/2-Mechanics/CLI/tables/ether-cyclones.md)
...
![The Outer Planes](/2-Mechanics/CLI/tables/the-outer-planes.md)
...
Traveling between the Outer Planes isn't dissimilar from reaching the Outer Planes in the first place. Characters traveling by means of the [astral projection](/2-Mechanics/CLI/spells/astral-projection.md) spell can go from one plane into the Astral Plane, and there search out a color pool leading to the desired destination. Characters can also use plane shift to reach a different plane more directly. Most often, though, characters use portals-either a portal that links the two planes directly or a portal leading to Sigil, City of Doors, which holds portals to all the planes.
...
This river bubbles with grease, foul flotsam, and the putrid remains of battles along its banks. Any creature other than a fiend that tastes or touches the water is affected by a [feeblemind](/2-Mechanics/CLI/spells/feeblemind.md) spell. The DC of the Intelligence saving throw to resist the effect is 15.
...
If a corrupted creature doesn't leave the plane within `1d4+2` days, its alignment changes to chaotic evil. Casting the [dispel evil and good](/2-Mechanics/CLI/spells/dispel-evil-and-good.md) spell on the creature restores its original alignment.

![Optional Rule: Abyssal Corruption; Abyssal Corruption](/2-Mechanics/CLI/tables/optional-rule-abyssal-corruption-abyssal-corruption.md)
...
![The Outlands and Sigil; Gate-Towns of the Outlands](/2-Mechanics/CLI/tables/the-outlands-and-sigil-gate-towns-of-the-outlands.md)
