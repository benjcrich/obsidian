...
![](/2-Mechanics/CLI/backgrounds/img/haunted-one.webp#right)  

- **Skill Proficiencies.** Choose two from among [Arcana](/2-Mechanics/CLI/rules/skills.md#Arcana), [Investigation](/2-Mechanics/CLI/rules/skills.md#Investigation), [Religion](/2-Mechanics/CLI/rules/skills.md#Religion), or [Survival](/2-Mechanics/CLI/rules/skills.md#Survival)  
...
- **Equipment.** [Monster hunter's pack](/2-Mechanics/CLI/items/monster-hunters-pack-vrgr.md) (containing a [chest](/2-Mechanics/CLI/items/chest.md), a [crowbar](/2-Mechanics/CLI/items/crowbar.md), a [hammer](/2-Mechanics/CLI/items/hammer.md), three wooden stakes, a [holy symbol](/2-Mechanics/CLI/items/holy-symbol.md), a [flask of holy water](/2-Mechanics/CLI/items/holy-water-flask.md), a [set of manacles](/2-Mechanics/CLI/items/manacles.md), a [steel mirror](/2-Mechanics/CLI/items/steel-mirror.md), a [flask of oil](/2-Mechanics/CLI/items/oil-flask.md), a [tinderbox](/2-Mechanics/CLI/items/tinderbox.md), and 3 [torches](/2-Mechanics/CLI/items/torch.md)), a set of [common clothes](/2-Mechanics/CLI/items/common-clothes.md), one [trinket](/2-Mechanics/CLI/items/trinket-cos.md) of special significance (choose one or roll on the [Horror Trinkets](/2-Mechanics/CLI/items/horror-trinket-vrgr.md) table), and 1 sp  
