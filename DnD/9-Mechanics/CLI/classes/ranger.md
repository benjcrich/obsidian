...
- (a) [scale mail](/2-Mechanics/CLI/items/scale-mail.md) or (b) [leather armor](/2-Mechanics/CLI/items/leather-armor.md)  
- (a) two [shortswords](/2-Mechanics/CLI/items/shortsword.md) or (b) two simple melee weapons  
...
- A [longbow](/2-Mechanics/CLI/items/longbow.md) and a [quiver](/2-Mechanics/CLI/items/quiver.md) of [20 arrows](/2-Mechanics/CLI/items/arrows-20.md)  
...
You can make a ranger quickly by following these suggestions. First, make Dexterity your highest ability score, followed by Wisdom. (Some rangers who focus on two-weapon fighting make Strength higher than Dexterity.) Second, choose the [outlander](/2-Mechanics/CLI/backgrounds/outlander.md) background.
...
Choose a type of favored enemy: aberrations, beasts, celestials, constructs, dragons, elementals, fey, fiends, giants, monstrosities, oozes, plants, or undead. Alternatively, you can select two races of humanoid (such as [gnolls](/2-Mechanics/CLI/bestiary/humanoid/gnoll.md) and [orcs](/2-Mechanics/CLI/bestiary/humanoid/orc.md)) as favored enemies.

You have advantage on Wisdom ([Survival](/2-Mechanics/CLI/rules/skills.md#Survival)) checks to track your favored enemies, as well as on Intelligence checks to recall information about them.
...
*1st-level ranger [optional class features](/2-Mechanics/CLI/rules/variant-rules/optional-class-features-tce.md), which replaces the Favored Enemy feature and works with the Foe Slayer feature*

When you hit a creature with an attack roll, you can call on your mystical bond with nature to mark the target as your favored enemy for 1 minute or until you lose your [concentration](/2-Mechanics/CLI/rules/conditions.md#concentration) (as if you were concentrating on a spell).
...
*1st-level ranger [optional class features](/2-Mechanics/CLI/rules/variant-rules/optional-class-features-tce.md), which replaces the Natural Explorer feature*
...
For example, if you know the 1st-level spell [animal friendship](/2-Mechanics/CLI/spells/animal-friendship.md) and have a 1st-level and a 2nd-level spell slot available, you can cast [animal friendship](/2-Mechanics/CLI/spells/animal-friendship.md) using either slot.
...
*2nd-level ranger [optional class features](/2-Mechanics/CLI/rules/variant-rules/optional-class-features-tce.md)*

You can use a [druidic focus](/2-Mechanics/CLI/items/druidic-focus.md) as a spellcasting focus for your ranger spells. A druidic focus might be a sprig of mistletoe or holly, a wand or rod made of yew or another special wood, a staff drawn whole from a living tree, or an object incorporating feathers, fur, bones, and teeth from sacred animals.
...
*3rd-level ranger [optional class features](/2-Mechanics/CLI/rules/variant-rules/optional-class-features-tce.md), which replaces the Primeval Awareness feature*
...
| Ranger Level | Spell |
|--------------|-------|
| 3rd | [speak with animals](/2-Mechanics/CLI/spells/speak-with-animals.md) |
| 5th | [beast sense](/2-Mechanics/CLI/spells/beast-sense.md) |
| 9th | [speak with plants](/2-Mechanics/CLI/spells/speak-with-plants.md) |
| 13th | [locate creature](/2-Mechanics/CLI/spells/locate-creature.md) |
| 17th | [commune with nature](/2-Mechanics/CLI/spells/commune-with-nature.md) |
^primal-awareness-spells
...
*4th-level ranger [optional class features](/2-Mechanics/CLI/rules/variant-rules/optional-class-features-tce.md)*
...
Once you are camouflaged in this way, you can try to hide by pressing yourself up against a solid surface, such as a tree or wall, that is at least as tall and wide as you are. You gain a +10 bonus to Dexterity ([Stealth](/2-Mechanics/CLI/rules/skills.md#Stealth)) checks as long as you remain there without moving or taking actions. Once you move or take an action or a reaction, you must camouflage yourself again to gain this benefit.

### Nature's Veil (Level 10)
_Source: Tasha's Cauldron of Everything p. 56_

*10th-level ranger [optional class features](/2-Mechanics/CLI/rules/variant-rules/optional-class-features-tce.md), which replaces the Hide in Plain Sight feature*

You draw on the powers of nature to hide yourself from view briefly. As a bonus action, you can magically become [invisible](/2-Mechanics/CLI/rules/conditions.md#invisible), along with any equipment you are wearing or carrying, until the start of your next turn.
...
In addition, whenever you finish a short rest, your [exhaustion](/2-Mechanics/CLI/rules/conditions.md#exhaustion) level, if any, is decreased by 1.
...
Starting at 14th level, you can use the [Hide](/2-Mechanics/CLI/rules/actions.md#Hide) action as a bonus action on your turn. Also, you can't be tracked by nonmagical means, unless you choose to leave a trail.
...
At 18th level, you gain preternatural senses that help you fight creatures you can't see. When you attack a creature you can't see, your inability to see it doesn't impose disadvantage on your attack rolls against it. You are also aware of the location of any [invisible](/2-Mechanics/CLI/rules/conditions.md#invisible) creature within 30 feet of you, provided that the creature isn't hidden from you and you aren't [blinded](/2-Mechanics/CLI/rules/conditions.md#blinded) or [deafened](/2-Mechanics/CLI/rules/conditions.md#deafened).
...
> ![Fighting Style, Ranger](/2-Mechanics/CLI/optional-features/list-fighting-style-ranger.md#Fighting%20Style,%20Ranger)
