...
- **Armor**: light
- **Weapons**: simple, [hand crossbows](/2-Mechanics/CLI/items/hand-crossbow.md), [longswords](/2-Mechanics/CLI/items/longsword.md), [rapiers](/2-Mechanics/CLI/items/rapier.md), [shortswords](/2-Mechanics/CLI/items/shortsword.md)
- **Tools**: [thieves' tools](/2-Mechanics/CLI/items/thieves-tools.md)
...
- (a) a [rapier](/2-Mechanics/CLI/items/rapier.md) or (b) a [shortsword](/2-Mechanics/CLI/items/shortsword.md)  
- (a) a [shortbow](/2-Mechanics/CLI/items/shortbow.md) and [quiver](/2-Mechanics/CLI/items/quiver.md) of [20 arrows](/2-Mechanics/CLI/items/arrows-20.md) or (b) a [shortsword](/2-Mechanics/CLI/items/shortsword.md)  
- (a) a [burglar's pack](/2-Mechanics/CLI/items/burglars-pack.md), (b) a [dungeoneer's pack](/2-Mechanics/CLI/items/dungeoneers-pack.md), or (c) an [explorer's pack](/2-Mechanics/CLI/items/explorers-pack.md)  
- [Leather armor](/2-Mechanics/CLI/items/leather-armor.md), two [daggers](/2-Mechanics/CLI/items/dagger.md), and [thieves' tools](/2-Mechanics/CLI/items/thieves-tools.md)  
...
You can make a rogue quickly by following these suggestions. First, Dexterity should be your highest ability score. Make Intelligence your next-highest if you want to excel at Investigation or plan to take up the Arcane Trickster archetype. Choose Charisma instead if you plan to emphasize deception and social interaction. Second, choose the [charlatan](/2-Mechanics/CLI/backgrounds/charlatan.md) background.
...
At 1st level, choose two of your skill proficiencies, or one of your skill proficiencies and your proficiency with [thieves' tools](/2-Mechanics/CLI/items/thieves-tools.md). Your proficiency bonus is doubled for any ability check you make that uses either of the chosen proficiencies.

At 6th level, you can choose two more of your proficiencies (in skills or with [thieves' tools](/2-Mechanics/CLI/items/thieves-tools.md)) to gain this benefit.

### Sneak Attack (Level 1)

Beginning at 1st level, you know how to strike subtly and exploit a foe's distraction. Once per turn, you can deal an extra `1d6` damage to one creature you hit with an attack if you have advantage on the attack roll. The attack must use a finesse or a ranged weapon.

You don't need advantage on the attack roll if another enemy of the target is within 5 feet of it, that enemy isn't [incapacitated](/2-Mechanics/CLI/rules/conditions.md#incapacitated), and you don't have disadvantage on the attack roll.
...
Starting at 2nd level, your quick thinking and agility allow you to move and act quickly. You can take a bonus action on each of your turns in combat. This action can be used only to take the [Dash](/2-Mechanics/CLI/rules/actions.md#Dash), [Disengage](/2-Mechanics/CLI/rules/actions.md#Disengage), or [Hide](/2-Mechanics/CLI/rules/actions.md#Hide) action.
...
*3rd-level rogue [optional class features](/2-Mechanics/CLI/rules/variant-rules/optional-class-features-tce.md)*
...
At 6th level, you can choose two more of your proficiencies (in skills or with [thieves' tools](/2-Mechanics/CLI/items/thieves-tools.md)) to gain the benefit of Expertise.

### Evasion (Level 7)

Beginning at 7th level, you can nimbly dodge out of the way of certain area effects, such as a red dragon's fiery breath or an [ice storm](/2-Mechanics/CLI/spells/ice-storm.md) spell. When you are subjected to an effect that allows you to make a Dexterity saving throw to take only half damage, you instead take no damage if you succeed on the saving throw, and only half damage if you fail.
...
Starting at 14th level, if you are able to hear, you are aware of the location of any hidden or [invisible](/2-Mechanics/CLI/rules/conditions.md#invisible) creature within 10 feet of you.
...
Beginning at 18th level, you are so evasive that attackers rarely gain the upper hand against you. No attack roll has advantage against you while you aren't [incapacitated](/2-Mechanics/CLI/rules/conditions.md#incapacitated).
