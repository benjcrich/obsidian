...
- item/wondrous
aliases: ["Devastation Orb of Earth"]
...
When this orb detonates, it subjects the area to the effects of the [earthquake](/2-Mechanics/CLI/spells/earthquake.md) spell for 1 minute (spell save DC 18). For the purpose of the spell's effects, the spell is cast on the turn that the orb explodes.
