...
When the trap is triggered, the net is released, covering a 10-foot-square area. Those in the area are trapped under the net and [restrained](/2-Mechanics/CLI/rules/conditions.md#restrained), and those that fail a DC 10 Strength saving throw are also knocked [prone](/2-Mechanics/CLI/rules/conditions.md#prone).
