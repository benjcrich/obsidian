...
Wedging an iron spike or other object under the pressure plate prevents the trap from activating. A successful [dispel magic](/2-Mechanics/CLI/spells/dispel-magic.md) (DC 13) cast on the statue destroys the trap.
