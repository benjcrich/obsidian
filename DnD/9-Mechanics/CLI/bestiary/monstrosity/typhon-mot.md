...
- "desc": "Melee Weapon Attack: +12 to hit, reach 15 ft., one Large or smaller creature.\
    \ Hit: 17 (3d6 + 7) bludgeoning damage, and the target is [grappled](/2-Mechanics/CLI/rules/conditions.md#grappled)\
...
"source":
- "MOT"
"image": "/2-Mechanics/CLI/bestiary/monstrosity/token/typhon.png"
```
^statblock
