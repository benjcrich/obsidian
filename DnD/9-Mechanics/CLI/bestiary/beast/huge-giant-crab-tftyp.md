...
- "desc": "Melee Weapon Attack: +9 to hit, reach 10 ft., one target. Hit: 27 (4d10\
    \ + 5) bludgeoning damage, and the target is [grappled](/2-Mechanics/CLI/rules/conditions.md#grappled),\
    \ escape DC 14. The crab has two claws, each of which can grapple only one target."
  "name": "Claw"
"source":
- "TftYP"
- "SLW"
"image": "/2-Mechanics/CLI/bestiary/beast/token/huge-giant-crab.png"
```
^statblock
