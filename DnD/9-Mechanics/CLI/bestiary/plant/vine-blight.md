...
- "desc": "Melee Weapon Attack: +4 to hit, reach 10 ft., one target. Hit: 9 (2d6\
    \ + 2) bludgeoning damage, and a Large or smaller target is [grappled](/2-Mechanics/CLI/rules/conditions.md#grappled)\
...
- "DIP"
- "BMT"
"image": "/2-Mechanics/CLI/bestiary/plant/token/vine-blight.png"
```
^statblock
