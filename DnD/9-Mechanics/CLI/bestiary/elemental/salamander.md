...
- "desc": "Melee Weapon Attack: +7 to hit, reach 10 ft., one target. Hit: 11 (2d6\
    \ + 4) bludgeoning damage plus 7 (2d6) fire damage, and the target is [grappled](/2-Mechanics/CLI/rules/conditions.md#grappled)\
...
- "GotSF"
- "BMT"
"image": "/2-Mechanics/CLI/bestiary/elemental/token/salamander.png"
```
^statblock
