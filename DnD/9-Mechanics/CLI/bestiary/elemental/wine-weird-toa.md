...
- "desc": "Melee Weapon Attack: +5 to hit, reach 10 ft., one creature. Hit: 13\
    \ (3d6 + 3) bludgeoning damage. If the target is Medium or smaller, it is [grappled](/2-Mechanics/CLI/rules/conditions.md#grappled)\
    ...
    \ the wine weird tries to drown it, and the wine weird can't constrict another\
    \ target."
  "name": "Constrict"
"source":
- "ToA"
"image": "/2-Mechanics/CLI/bestiary/elemental/token/wine-weird.png"
```
^statblock
