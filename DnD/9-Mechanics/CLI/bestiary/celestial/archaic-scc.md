...
- "desc": "Melee or Ranged Spell Attack: +14 to hit, reach 15 ft. or range 120 ft.,\
    \ one target. Hit: 19 (2d10 + 8) force damage, and the target is pulled up\
    \ to 10 feet toward the archaic or pushed 10 feet away from it, as the archaic\
    \ chooses."
  "name": "Force Strike"
...
"source":
- "SCC"
"image": "/2-Mechanics/CLI/bestiary/celestial/token/archaic.png"
```
^statblock
