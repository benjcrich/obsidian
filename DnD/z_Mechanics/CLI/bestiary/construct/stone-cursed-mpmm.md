...
- "desc": "Melee Weapon Attack: +5 to hit, reach 5 ft., one target. Hit: 12 (2d8\
    ...
    \ 12 Constitution saving throw, or it begins to turn to stone and is [restrained](/2-Mechanics/CLI/rules/conditions.md#restrained)\
...
- "MPMM"
- "MTF"
"image": "/2-Mechanics/CLI/bestiary/construct/token/stone-cursed.png"
```
^statblock
