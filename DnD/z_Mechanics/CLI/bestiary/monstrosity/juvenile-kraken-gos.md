...
- "desc": "Melee Weapon Attack: +12 to hit, reach 5 ft., one target. Hit: 20 (3d8\
    \ + 7) piercing damage. If the target is a Medium or smaller creature [grappled](/2-Mechanics/CLI/rules/conditions.md#grappled)\
...
"source":
- "GoS"
"image": "/2-Mechanics/CLI/bestiary/monstrosity/token/juvenile-kraken.png"
```
^statblock
