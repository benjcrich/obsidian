...
- "desc": "Melee Weapon Attack: +6 to hit, reach 5 ft., one target. Hit: 13 (2d8\
    \ + 4) piercing damage. If the target is a creature wearing armor of any type,\
    \ the aurumvorax gains one of the following benefits of its choice:"
  "name": "Bite"
...
- "desc": "Melee Weapon Attack: +6 to hit, reach 5 ft., one target. Hit: 11 (2d6\
    \ + 4) slashing damage. If the target is a Large or smaller creature, it is [grappled](/2-Mechanics/CLI/rules/conditions.md#grappled)\
    \ (escape DC 14). Until this grapple ends, the aurumvorax can't use its Claw attack\
    \ on another target, and when it moves, it can drag the [grappled](/2-Mechanics/CLI/rules/conditions.md#grappled)\
    \ creature with it, without the aurumvorax's speed being halved."
  "name": "Claw"
"source":
- "JttRC"
"image": "/2-Mechanics/CLI/bestiary/monstrosity/token/aurumvorax-den-leader.png"
```
^statblock
