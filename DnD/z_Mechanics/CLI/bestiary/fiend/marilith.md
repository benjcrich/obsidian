...
- "desc": "Melee Weapon Attack: +9 to hit, reach 10 ft., one creature. Hit: 15\
    \ (2d10 + 4) bludgeoning damage. If the target is Medium or smaller, it is [grappled](/2-Mechanics/CLI/rules/conditions.md#grappled)\
...
- "TCE"
- "DoDk"
"image": "/2-Mechanics/CLI/bestiary/fiend/token/marilith.png"
```
^statblock
