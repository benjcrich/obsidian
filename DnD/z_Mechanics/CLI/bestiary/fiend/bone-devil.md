...
- "desc": "Melee Weapon Attack: +8 to hit, reach 10 ft., one target. Hit: 13 (2d8\
    ...
    \ on a DC 14 Constitution saving throw or become [poisoned](/2-Mechanics/CLI/rules/conditions.md#poisoned)\
...
- "SatO"
- "DoDk"
"image": "/2-Mechanics/CLI/bestiary/fiend/token/bone-devil.png"
```
^statblock
