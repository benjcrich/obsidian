...
- The kraken can alter the weather at will in a 6-mile radius centered on its lair. The effect is identical to the [control weather](/2-Mechanics/CLI/spells/control-weather.md) spell.  
...
- Aquatic creatures within 6 miles of the lair that have an Intelligence score of 2 or lower are [charmed](/2-Mechanics/CLI/rules/conditions.md#charmed) by the kraken and aggressive toward intruders in the area.  
