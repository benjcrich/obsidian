...
- "desc": "Melee Weapon Attack: +11 to hit, reach 5 ft., one target. Hit: 10 (1d8\
    \ + 6) bludgeoning damage plus 18 (4d8) psychic damage, and if the target is\
    \ a creature, it must succeed on a DC 19 Constitution saving throw or be [incapacitated](/2-Mechanics/CLI/rules/conditions.md#incapacitated)\
...
- "MTF"
- "BMT"
"image": "/2-Mechanics/CLI/bestiary/aberration/token/star-spawn-seer.png"
```
^statblock
