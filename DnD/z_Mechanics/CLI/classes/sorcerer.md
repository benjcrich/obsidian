...
- **Armor**: none
- **Weapons**: [daggers](/2-Mechanics/CLI/items/dagger.md), [darts](/2-Mechanics/CLI/items/dart.md), [slings](/2-Mechanics/CLI/items/sling.md), [quarterstaffs](/2-Mechanics/CLI/items/quarterstaff.md), [light crossbows](/2-Mechanics/CLI/items/light-crossbow.md)
- **Tools**: none
- **Skills**: Choose 2 from *Arcana*, *Deception*, *Insight*, *Intimidation*, *Persuasion*, *Religion*

You begin play with the following equipment, in addition to any equipment provided by your background.

- (a) a [light crossbow](/2-Mechanics/CLI/items/light-crossbow.md) and [20 bolts](/2-Mechanics/CLI/items/crossbow-bolts-20.md) or (b) any simple weapon  
- (a) a [component pouch](/2-Mechanics/CLI/items/component-pouch.md) or (b) an [arcane focus](/2-Mechanics/CLI/items/arcane-focus.md)  
...
- Two [daggers](/2-Mechanics/CLI/items/dagger.md)  
...
You can make a sorcerer quickly by following these suggestions. First, Charisma should be your highest ability score, followed by Constitution. Second, choose the hermit background. Third, choose the [light](/2-Mechanics/CLI/spells/light.md), [prestidigitation](/2-Mechanics/CLI/spells/prestidigitation.md), [ray of frost](/2-Mechanics/CLI/spells/ray-of-frost.md), and [shocking grasp](/2-Mechanics/CLI/spells/shocking-grasp.md) cantrips, along with the 1st-level spells [shield](/2-Mechanics/CLI/spells/shield.md) and [magic missile](/2-Mechanics/CLI/spells/magic-missile.md).
...
For example, if you know the 1st-level spell [burning hands](/2-Mechanics/CLI/spells/burning-hands.md) and have a 1st-level and a 2nd-level spell slot available, you can cast [burning hands](/2-Mechanics/CLI/spells/burning-hands.md) using either slot.
...
You can use an [arcane focus](/2-Mechanics/CLI/items/arcane-focus.md) as a spellcasting focus for your sorcerer spells.
...
- [Careful Spell](/2-Mechanics/CLI/optional-features/careful-spell.md)  
- [Distant Spell](/2-Mechanics/CLI/optional-features/distant-spell.md)  
- [Empowered Spell](/2-Mechanics/CLI/optional-features/empowered-spell.md)  
- [Extended Spell](/2-Mechanics/CLI/optional-features/extended-spell.md)  
- [Heightened Spell](/2-Mechanics/CLI/optional-features/heightened-spell.md)  
- [Quickened Spell](/2-Mechanics/CLI/optional-features/quickened-spell.md)  
- [Subtle Spell](/2-Mechanics/CLI/optional-features/subtle-spell.md)  
- [Twinned Spell](/2-Mechanics/CLI/optional-features/twinned-spell.md)  

### Metamagic Options (Level 3)
_Source: Tasha's Cauldron of Everything p. 65_

*3rd-level sorcerer [optional class features](/2-Mechanics/CLI/rules/variant-rules/optional-class-features-tce.md)*
...
*4th-level sorcerer [optional class features](/2-Mechanics/CLI/rules/variant-rules/optional-class-features-tce.md)*
...
- Replace one of the options you chose for the Metamagic feature with a different [Metamagic option](/2-Mechanics/CLI/optional-features/list-metamagic.md) available to you.  
...
*5th-level sorcerer [optional class features](/2-Mechanics/CLI/rules/variant-rules/optional-class-features-tce.md)*
...
> [!example]- Metamagic
> ![Metamagic](/2-Mechanics/CLI/optional-features/list-metamagic.md#Metamagic)
^list-metamagic