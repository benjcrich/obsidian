...
You know the [mage hand](/2-Mechanics/CLI/spells/mage-hand.md) cantrip. When you reach 3rd level, you can cast the [Tenser's floating disk](/2-Mechanics/CLI/spells/tensers-floating-disk.md) spell once with this trait and regain the ability to do so when you finish a short or long rest. When you reach 5th level, you can cast the [arcane lock](/2-Mechanics/CLI/spells/arcane-lock.md) spell once with this trait, requiring no material component, and regain the ability to do so when you finish a long rest. Charisma is your spellcasting ability for these spells.
