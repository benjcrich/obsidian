...
- **Skill Proficiencies.** [Insight](z_Mechanics/CLI/rules/skills.md#Insight), [Persuasion](z_Mechanics/CLI/rules/skills.md#Persuasion)  
- **Tool Proficiencies.** One type of artisan's tools, or [navigator's tools](navigators-tools.md), or an additional language  
- **Languages.** One of your choice  
- **Equipment.** A set of artisan's tools (one of your choice) or a [mule](z_Mechanics/CLI/items/mule.md) and [cart](cart.md), a letter of introduction from your guild, a set of [traveler's clothes](travelers-clothes.md), and a belt [pouch](pouch.md) containing 15 gp  
