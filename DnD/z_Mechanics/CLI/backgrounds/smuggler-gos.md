...
- **Skill Proficiencies.** [Athletics](z_Mechanics/CLI/rules/skills.md#Athletics), [Deception](z_Mechanics/CLI/rules/skills.md#Deception)  
- **Tool Proficiencies.** Vehicles (water)  
- **Equipment.** A fancy leather vest or a pair of leather boots, a set of [common clothes](common-clothes.md), and a leather [pouch](pouch.md) with 15 gp  
