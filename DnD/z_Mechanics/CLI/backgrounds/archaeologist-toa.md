...
- **Tool Proficiencies.** [Cartographer's tools](cartographers-tools.md) or [navigator's tools](navigators-tools.md)  
- **Languages.** One of your choice  
- **Equipment.** A [wooden case](map-or-scroll-case.md) containing a map to a ruin or dungeon, a [bullseye lantern](bullseye-lantern.md), a [miner's pick](miners-pick.md), a set of [traveler's clothes](travelers-clothes.md), a [shovel](shovel.md), a [two-person tent](two-person-tent.md), a [trinket](trinket.md) recovered from a dig site, and a [pouch](pouch.md) containing 25 gp  
...
| dice: d8 | Item |
|----------|------|
| 1 | [10-foot pole](pole-10-foot.md) |
| 2 | [Crowbar](crowbar.md) |
| 3 | Hat |
| 4 | [Hooded lantern](hooded-lantern.md) |
| 5 | Medallion |
| 6 | [Shovel](shovel.md) |
| 7 | [Sledgehammer](sledgehammer.md) |
| 8 | [Whip](whip.md) |
^signature-item
