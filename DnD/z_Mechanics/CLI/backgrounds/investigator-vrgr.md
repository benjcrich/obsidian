...
- **Skill Proficiencies.** Choose two from among [Insight](z_Mechanics/CLI/rules/skills.md#Insight), [Investigation](z_Mechanics/CLI/rules/skills.md#Investigation), or [Perception](z_Mechanics/CLI/rules/skills.md#Perception)  
- **Tool Proficiencies.** [Disguise kit](disguise-kit.md), [Thieves' tools](thieves-tools.md)  
- **Equipment.** A [magnifying glass](magnifying-glass.md), evidence from a past case (choose one or roll for a trinket from the [Horror Trinkets](horror-trinket-vrgr.md) later in this chapter), a [set of common clothes](common-clothes.md), and 10 gp  
