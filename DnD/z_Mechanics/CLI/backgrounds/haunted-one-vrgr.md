...
- **Skill Proficiencies.** Choose two from among [Arcana](z_Mechanics/CLI/rules/skills.md#Arcana), [Investigation](z_Mechanics/CLI/rules/skills.md#Investigation), [Religion](z_Mechanics/CLI/rules/skills.md#Religion), or [Survival](z_Mechanics/CLI/rules/skills.md#Survival)  
...
- **Equipment.** [Monster hunter's pack](monster-hunters-pack-vrgr.md) (containing a [chest](chest.md), a [crowbar](crowbar.md), a [hammer](hammer.md), three wooden stakes, a [holy symbol](holy-symbol.md), a [flask of holy water](holy-water-flask.md), a [set of manacles](manacles.md), a [steel mirror](steel-mirror.md), a [flask of oil](oil-flask.md), a [tinderbox](tinderbox.md), and 3 [torches](torch.md)), a set of [common clothes](common-clothes.md), one [trinket](trinket-cos.md) of special significance (choose one or roll on the [Horror Trinkets](horror-trinket-vrgr.md) table), and 1 sp  
