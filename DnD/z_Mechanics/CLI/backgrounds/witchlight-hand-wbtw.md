...
- **Skill Proficiencies.** [Performance](z_Mechanics/CLI/rules/skills.md#Performance), [Sleight of Hand](z_Mechanics/CLI/rules/skills.md#Sleight%20of%20Hand)  
- **Tool Proficiencies.** [Disguise kit](disguise-kit.md) or one type of musical Instrument  
- **Languages.** One of your choice  
- **Equipment.** A [disguise kit](disguise-kit.md) or a musical instrument of your choice, a deck of cards, a carnival uniform or [costume](costume-clothes.md), one trinket (determined by rolling on the [Feywild Trinkets](feywild-trinket-wbtw.md)), and a [pouch](pouch.md) containing 8 gp  
