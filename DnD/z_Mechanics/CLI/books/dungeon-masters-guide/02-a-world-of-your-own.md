...
![A Sample Pantheon; Dawn War Deities](/2-Mechanics/CLI/tables/a-sample-pantheon-dawn-war-deities.md)
...
![Forms of Government](/2-Mechanics/CLI/tables/forms-of-government.md)
...
![Government; Sample Hierarchy of Noble Titles](/2-Mechanics/CLI/tables/government-sample-hierarchy-of-noble-titles.md)
...
![Examples of Faction Ranks](/2-Mechanics/CLI/tables/examples-of-faction-ranks.md)
...
![World-Shaking Events](/2-Mechanics/CLI/tables/world-shaking-events.md)
...
![Rise or Fall of a Leader or an Era; Leader Types](/2-Mechanics/CLI/tables/rise-or-fall-of-a-leader-or-an-era-leader-types.md)
...
![Cataclysmic Disasters](/2-Mechanics/CLI/tables/cataclysmic-disasters.md)
...
![Assault or Invasion; Invading Forces](/2-Mechanics/CLI/tables/assault-or-invasion-invading-forces.md)
...
![Extinction or Depletion](/2-Mechanics/CLI/tables/extinction-or-depletion.md)
...
![New Organizations](/2-Mechanics/CLI/tables/new-organizations.md)
...
![Discovery, Expansion, Invention; Discoveries](/2-Mechanics/CLI/tables/discovery-expansion-invention-discoveries.md)
...
> 
> ![The Calendar of Harptos](/2-Mechanics/CLI/tables/the-calendar-of-harptos.md)
...
Dedicated spellcasters learn 3rd-level spells at the start of this tier. Suddenly characters can fly, damage large numbers of foes with [fireball](/2-Mechanics/CLI/spells/fireball.md) and [lightning bolt](/2-Mechanics/CLI/spells/lightning-bolt.md) spells, and even breathe underwater. They master 5th-level spells by the end of the tier, and spells such as [teleportation circle](/2-Mechanics/CLI/spells/teleportation-circle.md), [scrying](/2-Mechanics/CLI/spells/scrying.md), [flame strike](/2-Mechanics/CLI/spells/flame-strike.md), [legend lore](/2-Mechanics/CLI/spells/legend-lore.md), and [raise dead](/2-Mechanics/CLI/spells/raise-dead.md) can have a significant impact on their adventures. They start acquiring more permanent magic items (uncommon and rare ones) as well, which will serve them for the rest of their careers.
...
Dedicated spellcasters gain access to 6th-level spells at 11th level, including spells that completely change the way adventurers interact with the world. Their big, flashy spells are significant in combat-[disintegrate](/2-Mechanics/CLI/spells/disintegrate.md), [blade barrier](/2-Mechanics/CLI/spells/blade-barrier.md), and [heal](/2-Mechanics/CLI/spells/heal.md), for example-but behind-the-scenes spells such as [word of recall](/2-Mechanics/CLI/spells/word-of-recall.md), [find the path](/2-Mechanics/CLI/spells/find-the-path.md), [contingency](/2-Mechanics/CLI/spells/contingency.md), [teleport](/2-Mechanics/CLI/spells/teleport.md), and [true seeing](/2-Mechanics/CLI/spells/true-seeing.md) alter the way players approach their adventures. Each spell level after that point introduces new effects with an equally large impact. The adventurers find rare magic items (and very rare ones) that bestow similarly powerful abilities.
...
Dedicated spellcasters at this tier wield earthshaking 9th-level spells such as [wish](/2-Mechanics/CLI/spells/wish.md), [gate](/2-Mechanics/CLI/spells/gate.md), [storm of vengeance](/2-Mechanics/CLI/spells/storm-of-vengeance.md), and [astral projection](/2-Mechanics/CLI/spells/astral-projection.md). Characters have several rare and very rare magic items at their disposal, and begin discovering legendary items such as a [vorpal sword](/2-Mechanics/CLI/items/vorpal-sword.md) or a [staff of the magi](/2-Mechanics/CLI/items/staff-of-the-magi.md).
...
![Starting at Higher Level; Starting Equipment](/2-Mechanics/CLI/tables/starting-at-higher-level-starting-equipment.md)
...
![Wuxia Weapon Names](/2-Mechanics/CLI/tables/wuxia-weapon-names.md)
