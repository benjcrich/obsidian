...
Appendix C of this book contains the [Secrets Deck](secrets-deck-wdmm.md)—paper cards for you to photocopy and hand out to the players when their characters learn reliable information about Halaster and Undermountain.

Any character who spends at least four hours in the Yawning Portal is likely to overhear tall tales about the Mad Mage and his dungeon. Not all rumors are to be believed, however, and characters need keen ears and sharp insight to determine which stories have weight. Have each character make a DC 20 Intelligence ([Investigation](z_Mechanics/CLI/rules/skills.md#Investigation)) check or Wisdom ([Insight](z_Mechanics/CLI/rules/skills.md#Insight)) check. If the check succeeds, the character learns a secret about Undermountain, and the player can draw a card from the [Secrets Deck](secrets-deck-wdmm.md).

Players can hold onto these cards for later reference. When the characters meet an NPC in Undermountain who knows a fact, have one of the players draw another card from the [Secrets Deck](secrets-deck-wdmm.md) to determine what that NPC knows about Halaster and his dungeon.
...
### Guild of Many Eyes
![](/2-Mechanics/CLI/decks/img/guildofmanyeyes.webp#card)
...
### Immortal Insanity
![](/2-Mechanics/CLI/decks/img/immortalinsanity.webp#card)
...
### Skullport
![](/2-Mechanics/CLI/decks/img/skullport.webp#card)
...
### Tangled Web
![](/2-Mechanics/CLI/decks/img/tangledweb.webp#card)
...
### Arcturiadoom
![](/2-Mechanics/CLI/decks/img/arcturiadoom.webp#card)
...
### What Drow Fear
![](/2-Mechanics/CLI/decks/img/whatdrowfear.webp#card)
...
### Dwarfcraft
![](/2-Mechanics/CLI/decks/img/dwarfcraft.webp#card)
...
### School of Magic
![](/2-Mechanics/CLI/decks/img/schoolofmagic.webp#card)
...
### Mad House
![](/2-Mechanics/CLI/decks/img/madhouse.webp#card)
...
### Underground Forest
![](/2-Mechanics/CLI/decks/img/undergroundforest.webp#card)
...
### Scavenger
![](/2-Mechanics/CLI/decks/img/scavenger.webp#card)
...
### Trobriand's Army
![](/2-Mechanics/CLI/decks/img/trobriandsarmy.webp#card)
...
### Death Tyrant
![](/2-Mechanics/CLI/decks/img/deathtyrant.webp#card)
...
### Nester's Fate
![](/2-Mechanics/CLI/decks/img/nestersfate.webp#card)
...
### Dark Elf Menace
![](/2-Mechanics/CLI/decks/img/darkelfmenace.webp#card)
...
### Emerald Blade
![](/2-Mechanics/CLI/decks/img/emeraldblade.webp#card)
...
![](/2-Mechanics/CLI/decks/img/githwhoscomingtodinner.webp#card)
...
### Spire and Snail
![](/2-Mechanics/CLI/decks/img/spireandsnail.webp#card)
