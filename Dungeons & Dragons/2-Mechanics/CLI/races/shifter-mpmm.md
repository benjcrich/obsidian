...
![](/2-Mechanics/CLI/races/img/shifter.webp#right)  
...
Channeling the beast within, you have proficiency in one of the following skills of your choice: [Acrobatics](/2-Mechanics/CLI/rules/skills.md#Acrobatics), [Athletics](/2-Mechanics/CLI/rules/skills.md#Athletics), [Intimidation](/2-Mechanics/CLI/rules/skills.md#Intimidation), or [Survival](/2-Mechanics/CLI/rules/skills.md#Survival).
...
- **Wildhunt.** While shifted, you have advantage on Wisdom checks, and no creature within 30 feet of you can make an attack roll with advantage against you unless you're [incapacitated](/2-Mechanics/CLI/rules/conditions.md#incapacitated).  
