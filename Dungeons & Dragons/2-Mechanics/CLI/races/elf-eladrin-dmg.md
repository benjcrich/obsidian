...
You can cast the [misty step](/2-Mechanics/CLI/spells/misty-step.md) spell once using this trait. You regain the ability to do so when you finish a short or long rest.