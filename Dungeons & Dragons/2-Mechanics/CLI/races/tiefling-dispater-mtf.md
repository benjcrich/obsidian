...
You know the [thaumaturgy](/2-Mechanics/CLI/spells/thaumaturgy.md) cantrip. When you reach 3rd level, you can cast the [disguise self](/2-Mechanics/CLI/spells/disguise-self.md) spell once with this trait and regain the ability to do so when you finish a long rest. When you reach 5th level, you can cast the [detect thoughts](/2-Mechanics/CLI/spells/detect-thoughts.md) spell once with this trait and regain the ability to do so when you finish a long rest. Charisma is your spellcasting ability for these spells.
