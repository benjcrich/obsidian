...
- Being subjected to spells that affect mental stability, such as the insanity option of the [symbol](/2-Mechanics/CLI/spells/symbol.md) spell  
...
A failed Sanity save might result in [short-term](/2-Mechanics/CLI/tables/short-term-madness.md), [long-term](/2-Mechanics/CLI/tables/long-term-madness.md), or [indefinite madness](/2-Mechanics/CLI/tables/indefinite-madness.md), as described in chapter 8, "Running the Game." Any time a character suffers from long-term or indefinite madness, the character's Sanity is reduced by 1. A [greater restoration](/2-Mechanics/CLI/spells/greater-restoration.md) spell can restore Sanity lost in this way, and a character can increase his or her Sanity through level advancement.