...
At the end of the day, the ship's bosun can make a Strength check using [carpenter's tools](/2-Mechanics/CLI/items/carpenters-tools.md). On a 15 or higher, each damaged component regains hit points equal to `1d6` + the crew's quality score (minimum of 1 hit point). A component other than the hull that had 0 hit points becomes functional again.
