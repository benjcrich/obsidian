...
- "desc": "Melee Weapon Attack: +8 to hit, reach 5 ft., one target. Hit: 12 (2d8\
    \ + 3) force damage. If the target is a creature, it must succeed on a DC 16\
    \ Constitution saving throw or take 16 (3d10) poison damage and become [poisoned](/2-Mechanics/CLI/rules/conditions.md#poisoned)\
...
- "MPMM"
- "MTF"
"image": "/2-Mechanics/CLI/bestiary/fiend/token/green-abishai.png"
```
^statblock
