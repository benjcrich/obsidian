...
- "desc": "Melee Weapon Attack: +6 to hit, reach 5 ft., one target. Hit: 10 (2d6\
    \ + 3) piercing damage, plus 22 (4d10) psychic damage if the target is [frightened](/2-Mechanics/CLI/rules/conditions.md#frightened).\
...
- "MPMM"
- "MTF"
"image": "/2-Mechanics/CLI/bestiary/fiend/token/howler.png"
```
^statblock
