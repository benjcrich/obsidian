...
- "desc": "Melee Weapon Attack: +9 to hit, reach 5 ft., one target. Hit: 12 (2d6\
    \ + 5) slashing damage. If the target is a creature, it must succeed on a DC\
    \ 16 Constitution saving throw or take 5 (2d4) slashing damage at the start\
...
- "SatO"
- "ToFW"
"image": "/2-Mechanics/CLI/bestiary/fiend/token/nycaloth.png"
```
^statblock
