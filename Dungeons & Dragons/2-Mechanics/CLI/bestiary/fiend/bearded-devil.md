...
- "desc": "Melee Weapon Attack: +5 to hit, reach 5 ft., one creature. Hit: 6 (1d8\
    ...
    \ minute. While [poisoned](/2-Mechanics/CLI/rules/conditions.md#poisoned) in this\
...
- "desc": "Melee Weapon Attack: +5 to hit, reach 10 ft., one target. Hit: 8 (1d10\
    ...
    \ the wound increases by 5 (1d10). Any creature can take an action to stanch\
...
- "BMT"
- "DoDk"
"image": "/2-Mechanics/CLI/bestiary/fiend/token/bearded-devil.png"
```
^statblock
