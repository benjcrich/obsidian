...
- "desc": "Melee Weapon Attack: +6 to hit, reach 5 ft., one target. Hit: 13 (2d8\
    ...
    \ also reduced by 3 (1d6). This reduction lasts until the target finishes a\
    \ short or long rest. The target dies if its hit point maximum is reduced to 0."
  "name": "Tentacle"
...
- "MTF"
- "AATM"
"image": "/2-Mechanics/CLI/bestiary/fiend/token/dybbuk.png"
```
^statblock
