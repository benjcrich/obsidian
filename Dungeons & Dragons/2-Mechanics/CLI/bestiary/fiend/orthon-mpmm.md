...
- "desc": "Melee Weapon Attack: +10 to hit, reach 5 ft., one target. Hit: 11 (2d4\
    ...
    \ a successful one. On a failure, the target is [poisoned](/2-Mechanics/CLI/rules/conditions.md#poisoned)\
...
- "MPMM"
- "MTF"
"image": "/2-Mechanics/CLI/bestiary/fiend/token/orthon.png"
```
^statblock
