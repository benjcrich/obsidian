...
- Demogorgon casts the [darkness](/2-Mechanics/CLI/spells/darkness.md) spell four times at its lowest level, targeting different areas with the spell. Demogorgon doesn't need to concentrate on the spells, which end on initiative count 20 of the next round.  
