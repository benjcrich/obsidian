...
- The hag creates a blizzard in a 40-foot-high, 20-foot radius cylinder centered on a point she can see within 120 feet of her. The effect lasts until initiative count 20 on the next round. The blizzard lightly obscures every creature and object in the area for the duration. A creature that enters the blizzard for the first time on a turn or starts its turn there is [blinded](/2-Mechanics/CLI/rules/conditions.md#blinded) until initiative count 20 on the next round.  
...
- Beasts that have an Intelligence score of 2 or lower are [charmed](/2-Mechanics/CLI/rules/conditions.md#charmed) by the hag and directed to be aggressive toward intruders in the area.  
...
- Small avalanches of snow intermittently fall, blocking a path or burying intruders. A buried creature is [restrained](/2-Mechanics/CLI/rules/conditions.md#restrained) and has to hold its breath until it is dug out.  
