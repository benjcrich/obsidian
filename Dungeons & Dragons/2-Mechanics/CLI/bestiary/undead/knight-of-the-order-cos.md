...
- "desc": "Melee Weapon Attack: +7 to hit, reach 5 ft., one target. Hit: 15 (2d10\
    \ + 4) slashing damage. If the target is a creature against which the knight\
    \ has sworn vengeance, the target takes an extra 14 (4d6) slashing damage."
  "name": "Longsword"
...
"source":
- "CoS"
"image": "/2-Mechanics/CLI/bestiary/undead/token/knight-of-the-order.png"
```
^statblock
