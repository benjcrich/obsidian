...
- "desc": "Melee Weapon Attack: +12 to hit, reach 5 ft., one creature. Hit: 21\
    \ (3d10 + 5) psychic damage. If the target is Large or smaller, it is [grappled](/2-Mechanics/CLI/rules/conditions.md#grappled)\
...
"source":
- "VGM"
"image": "/2-Mechanics/CLI/bestiary/undead/token/illithilich.png"
```
^statblock
