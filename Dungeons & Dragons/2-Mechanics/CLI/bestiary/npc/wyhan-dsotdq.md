...
---
# [Wyhan](2-Mechanics/CLI/bestiary/npc/wyhan-dsotdq.md)
...
- "desc": "Wyhan is a 9th-level spellcaster. Its spellcasting ability is Intelligence\
    \ (spell save DC 14, +6 to hit with spell attacks). Wyhan has the following wizard\
...
"source":
- "DSotDQ"
"image": "/2-Mechanics/CLI/bestiary/npc/token/wyhan.png"
```
^statblock
