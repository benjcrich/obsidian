...
- "desc": "Whenever Vasilka starts its turn with 40 hit points or fewer, roll a d6.\
    ...
    \ (Persuasion) check. If the check succeeds, Vasilka ceases being berserk. If\
    \ it takes damage while still at 40 hit points or fewer, Vasilka might go berserk\
    \ again."
  "name": "Berserk"
...
"source":
- "CoS"
"image": "/2-Mechanics/CLI/bestiary/npc/token/vasilka.png"
```
^statblock
