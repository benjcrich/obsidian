...
- "desc": "Melee Weapon Attack: +6 to hit, reach 5 ft., one creature. Hit: 6 (1d6\
    \ + 3) bludgeoning damage, and Ulder pushes the target 5 feet away from him.\
    \ Ulder then enters the space vacated by the target. If the target is pushed to\
    \ within 5 feet of a creature friendly to Ulder, the target provokes an opportunity\
...
"source":
- "BGDIA"
"image": "/2-Mechanics/CLI/bestiary/npc/token/ulder-ravengard.png"
```
^statblock
