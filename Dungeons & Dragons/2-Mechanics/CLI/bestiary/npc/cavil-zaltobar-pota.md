...
---
# [Cavil Zaltobar](2-Mechanics/CLI/bestiary/npc/cavil-zaltobar-pota.md)
...
- "desc": "Cavil is a 9th-level spellcaster. Its spellcasting ability is Intelligence\
    \ (spell save DC 14, +6 to hit with spell attacks). Cavil has the following wizard\
...
"source":
- "PotA"
"image": "/2-Mechanics/CLI/bestiary/npc/token/cavil-zaltobar.png"
```
^statblock
