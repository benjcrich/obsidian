...
- "desc": "Melee Weapon Attack: +10 to hit, reach 5 ft., one Large or smaller creature.\
    ...
    \ DC 16) if the eldritch horror isn't already constricting a creature, and the\
    \ target is [restrained](/2-Mechanics/CLI/rules/conditions.md#restrained) until\
    \ this grapple ends."
  "name": "Constrict"
...
"source":
- "KftGV"
"image": "/2-Mechanics/CLI/bestiary/monstrosity/token/juvenile-eldritch-horror.png"
```
^statblock
