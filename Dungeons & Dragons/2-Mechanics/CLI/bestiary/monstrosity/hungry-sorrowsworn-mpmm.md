...
- "desc": "Melee Weapon Attack: +8 to hit, reach 10 ft., one target. Hit: 18 (4d6\
    \ + 4) slashing damage. If the target is Medium or smaller, it is [grappled](/2-Mechanics/CLI/rules/conditions.md#grappled)\
...
- "MPMM"
- "MTF"
"image": "/2-Mechanics/CLI/bestiary/monstrosity/token/hungry-sorrowsworn.png"
```
^statblock
