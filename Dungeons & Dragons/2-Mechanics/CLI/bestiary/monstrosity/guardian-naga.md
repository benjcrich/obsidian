...
- "desc": "The naga is an 11th-level spellcaster. Its spellcasting ability is Wisdom\
    ...
    \ (3 slots): [calm emotions](/2-Mechanics/CLI/spells/calm-emotions.md), [hold\
    \ person](/2-Mechanics/CLI/spells/hold-person.md)\n\n3rd level (3 slots):\
...
- "AATM"
- "BMT"
"image": "/2-Mechanics/CLI/bestiary/monstrosity/token/guardian-naga.png"
```
^statblock
