...
- "desc": "Melee Weapon Attack: +4 to hit, reach 5 ft., one creature. Hit: 4 (1d4\
    ...
    \ 1 hour. If the saving throw fails by 5 or more, the target falls [unconscious](/2-Mechanics/CLI/rules/conditions.md#unconscious)\
...
- "IDRotF"
- "DoDk"
"image": "/2-Mechanics/CLI/bestiary/dragon/token/pseudodragon.png"
```
^statblock
