...
- "desc": "Melee Weapon Attack: +7 to hit, reach 5 ft., one target. Hit: 13 (2d8\
    \ + 4) bludgeoning damage plus 11 (2d10) damage of a type determined by the\
    \ animated breath's form: acid, cold, fire, lightning, or poison."
  "name": "Slam"
"bonus_actions":
...
"source":
- "FTD"
"image": "/2-Mechanics/CLI/bestiary/elemental/token/animated-breath.png"
```
^statblock
