...
- "desc": "Melee Weapon Attack: +3 to hit, reach 5 ft., one creature. Hit: 4 (1d6\
    ...
    \ minute. If the saving throw fails by 5 or more, the target is also [paralyzed](/2-Mechanics/CLI/rules/conditions.md#paralyzed)\
...
- "JttRC"
- "LoX"
"image": "/2-Mechanics/CLI/bestiary/humanoid/token/thri-kreen.png"
```
^statblock
