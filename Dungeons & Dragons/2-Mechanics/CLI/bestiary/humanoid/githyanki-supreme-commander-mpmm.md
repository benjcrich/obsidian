...
- "desc": "Melee Weapon Attack: +12 to hit, reach 5 ft., one target. Hit: 14 (2d6\
    ...
    \ a target in an astral body (as with the [astral projection](/2-Mechanics/CLI/spells/astral-projection.md)\
...
- "MPMM"
- "MTF"
"image": "/2-Mechanics/CLI/bestiary/humanoid/token/githyanki-supreme-commander.png"
```
^statblock
