...
|-------------|---------------|
| 3rd | [blindness/deafness](/2-Mechanics/CLI/spells/blindness-deafness.md), [gentle repose](/2-Mechanics/CLI/spells/gentle-repose.md) |
| 5th | [animate dead](/2-Mechanics/CLI/spells/animate-dead.md), [gaseous form](/2-Mechanics/CLI/spells/gaseous-form.md) |
| 7th | [blight](/2-Mechanics/CLI/spells/blight.md), [confusion](/2-Mechanics/CLI/spells/confusion.md) |
| 9th | [cloudkill](/2-Mechanics/CLI/spells/cloudkill.md), [contagion](/2-Mechanics/CLI/spells/contagion.md) |
^circle-of-spores-spells
...
At 6th level, your spores gain the ability to infest a corpse and animate it. If a beast or a humanoid that is Small or Medium dies within 10 feet of you, you can use your reaction to animate it, causing it to stand up immediately with 1 hit point. The creature uses the [zombie](/2-Mechanics/CLI/bestiary/undead/zombie.md) stat block in the "Monster Manual". It remains animate for 1 hour, after which time it collapses and dies.
