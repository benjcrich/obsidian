...
- (a) five [javelins](/2-Mechanics/CLI/items/javelin.md) or (b) any simple melee weapon  
- (a) a [priest's pack](/2-Mechanics/CLI/items/priests-pack.md) or (b) an [explorer's pack](/2-Mechanics/CLI/items/explorers-pack.md)  
- [Chain mail](/2-Mechanics/CLI/items/chain-mail.md) and a [holy symbol](/2-Mechanics/CLI/items/holy-symbol.md)  
...
You can make a paladin quickly by following these suggestions. First, Strength should be your highest ability score, followed by Charisma. Second, choose the [noble](/2-Mechanics/CLI/backgrounds/noble.md) background.
...
The presence of strong evil registers on your senses like a noxious odor, and powerful good rings like heavenly music in your ears. As an action, you can open your awareness to detect such forces. Until the end of your next turn, you know the location of any celestial, fiend, or undead within 60 feet of you that is not behind total cover. You know the type (celestial, fiend, or undead) of any being whose presence you sense, but not its identity (the vampire Count Strahd von Zarovich, for instance). Within the same radius, you also detect the presence of any place or object that has been consecrated or desecrated, as with the [hallow](/2-Mechanics/CLI/spells/hallow.md) spell.
...
You can use a [holy symbol](/2-Mechanics/CLI/items/holy-symbol.md) as a spellcasting focus for your paladin spells.
...
*3rd-level paladin [optional class features](/2-Mechanics/CLI/rules/variant-rules/optional-class-features-tce.md)*
...
*4th-level paladin [optional class features](/2-Mechanics/CLI/rules/variant-rules/optional-class-features-tce.md)*

Whenever you reach a level in this class that grants the Ability Score Improvement feature, you can replace a [fighting style](/2-Mechanics/CLI/optional-features/list-fighting-style-paladin.md) you know with another fighting style available to paladins. This replacement represents a shift of focus in your martial practice.
...
Starting at 10th level, you and friendly creatures within 10 feet of you can't be [frightened](/2-Mechanics/CLI/rules/conditions.md#frightened) while you are conscious.
...
> ![Fighting Style, Paladin](/2-Mechanics/CLI/optional-features/list-fighting-style-paladin.md#Fighting%20Style,%20Paladin)
