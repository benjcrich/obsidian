...
> 
> | Level | Cantrips Known | Spells Known | Spell Slots | Slot Level | [Invocations Known](/2-Mechanics/CLI/optional-features/list-eldritch-invocation.md) |
> |-------|----------------|--------------|-------------|------------|-------------------------------------------------------------------------------------|
> | 1st | 2 | 2 | 1 | 1st | ⏤ |
> | 2nd | 2 | 3 | 2 | 1st | 2 |
> | 3rd | 2 | 4 | 2 | 2nd | 2 |
...
- (a) a [scholar's pack](/2-Mechanics/CLI/items/scholars-pack.md) or (b) a [dungeoneer's pack](/2-Mechanics/CLI/items/dungeoneers-pack.md)  
- [Leather armor](/2-Mechanics/CLI/items/leather-armor.md), any simple weapon, and two [daggers](/2-Mechanics/CLI/items/dagger.md)  
...
You can make a warlock quickly by following these suggestions. First, Charisma should be your highest ability score, followed by Constitution. Second, choose the [charlatan](/2-Mechanics/CLI/backgrounds/charlatan.md) background. Third, choose the [eldritch blast](/2-Mechanics/CLI/spells/eldritch-blast.md) and [chill touch](/2-Mechanics/CLI/spells/chill-touch.md) cantrips, along with the 1st-level spells [charm person](/2-Mechanics/CLI/spells/charm-person.md) and [witch bolt](/2-Mechanics/CLI/spells/witch-bolt.md).
...
For example, when you are 5th level, you have two 3rd-level spell slots. To cast the 1st-level spell [witch bolt](/2-Mechanics/CLI/spells/witch-bolt.md), you must spend one of those slots, and you cast it as a 3rd-level spell.
...
You can use an [arcane focus](/2-Mechanics/CLI/items/arcane-focus.md) as a spellcasting focus for your warlock spells.
...
*4th-level warlock [optional class features](/2-Mechanics/CLI/rules/variant-rules/optional-class-features-tce.md)*
...
> ![Eldritch Invocation](/2-Mechanics/CLI/optional-features/list-eldritch-invocation.md#Eldritch%20Invocation)
^list-eldritch-invocation

> [!example]- Pact Boon
> ![Pact Boon](/2-Mechanics/CLI/optional-features/list-pact-boon.md#Pact%20Boon)
^list-pact-boon