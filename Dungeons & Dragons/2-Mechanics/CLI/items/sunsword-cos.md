...
![](/2-Mechanics/CLI/items/img/sunsword.webp#right)  
...
The hilt, which is sentient, knows that it can never be reunited with its original crystal blade. It has, however, gained the properties of a [sun blade](/2-Mechanics/CLI/items/sun-blade.md):
