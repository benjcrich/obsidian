...
A brass horn summons `3d4 + 3` [berserkers](/2-Mechanics/CLI/bestiary/humanoid/berserker.md). To use the brass horn, you must be proficient with all simple weapons.
