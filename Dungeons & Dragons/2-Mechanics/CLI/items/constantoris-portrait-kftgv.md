...
![](/2-Mechanics/CLI/items/img/constantoris-portrait.webp#right)  
...
The painting is a Small object with AC 12, 20 hit points, and immunity to poison damage. In its gold-leaf frame, the painting weighs 15 pounds. If the painting has at least 1 hit point and is targeted by a [mending](/2-Mechanics/CLI/spells/mending.md) spell, it regains `2d6` hit points.
