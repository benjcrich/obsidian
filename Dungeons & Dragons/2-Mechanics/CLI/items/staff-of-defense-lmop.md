...
The staff has 10 charges, which are used to fuel the spells within it. With the staff in hand, you can use your action to cast one of the following spells from the staff if the spell is on your class's spell list: [mage armor](/2-Mechanics/CLI/spells/mage-armor.md) (1 charge) or [shield](/2-Mechanics/CLI/spells/shield.md) (2 charges). No components are required.
