...
- 3 [minor beneficial properties](/2-Mechanics/CLI/tables/artifact-properties-minor-beneficial-properties.md)  
- 1 [major beneficial property](/2-Mechanics/CLI/tables/artifact-properties-major-beneficial-properties.md)  
- 3 [minor detrimental properties](/2-Mechanics/CLI/tables/artifact-properties-minor-detrimental-properties.md)  
- 2 [major detrimental properties](/2-Mechanics/CLI/tables/artifact-properties-major-detrimental-properties.md)  
