...
| 21–25 | A cricket-shaped creature with the statistics of a [cat](/2-Mechanics/CLI/bestiary/beast/cat.md) bounds up to one random creature and follows it like an affectionate pet for 24 hours before scampering off. |
| 26–30 | A cluster of `1d4 + 2` faintly glowing grubs appears in an unoccupied space within 30 feet of the party. Any creature that consumes one of these succulent grubs receives the benefits of a [potion of healing](/2-Mechanics/CLI/items/potion-of-healing.md). |
...
| 51–55 | A massive, bloated maggot emerges from the ground within 10 feet of the party and bursts, covering the ground with ichor in a 10-foot square centered on it. This region is affected by the [grease](/2-Mechanics/CLI/spells/grease.md) spell (save DC 13) for 1 minute. |
...
| 71–75 | One of the characters in the region must succeed on a DC 15 Wisdom saving throw or be transformed into a giant spider, as if by the [polymorph](/2-Mechanics/CLI/spells/polymorph.md) spell. The spell lasts for 1 hour or until dispelled. |
