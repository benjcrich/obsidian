...
| 06–10 | The region becomes a dead-magic zone for 1 hour. For the duration, the entire region is affected by the [antimagic field](/2-Mechanics/CLI/spells/antimagic-field.md) spell. |
| 11–15 | One random creature in the region must succeed on a DC 15 Dexterity saving throw or be enclosed in [Otiluke's resilient sphere](/2-Mechanics/CLI/spells/otilukes-resilient-sphere.md) for 1 minute. |
...
| 26–30 | One of the characters in the region must succeed on a DC 15 Wisdom saving throw or be transformed into a [blink dog](/2-Mechanics/CLI/bestiary/fey/blink-dog.md), as if by the [polymorph](/2-Mechanics/CLI/spells/polymorph.md) spell. The spell lasts for 1 hour or until dispelled. |
...
| 46–50 | The [flaming sphere](/2-Mechanics/CLI/spells/flaming-sphere.md) spell (save DC 15) spontaneously activates in an unoccupied space within 5 feet of the party. On initiative count 20 (losing all ties), the sphere moves 30 feet toward the nearest creature. The sphere vanishes after 1 minute. |
...
| 76–80 | The [reverse gravity](/2-Mechanics/CLI/spells/reverse-gravity.md) spell (save DC 18) activates for 1 minute, centered on the ground beneath one random creature in the region. |
...
| 96–00 | One random creature in the region can suddenly cast the [wish](/2-Mechanics/CLI/spells/wish.md) spell once, within the next minute. Reroll if you've rolled this effect in the past 24 hours. |
^unraveling-magic-effects