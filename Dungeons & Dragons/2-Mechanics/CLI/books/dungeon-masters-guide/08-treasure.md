...
![Individual Treasure: Challenge 0—4](/2-Mechanics/CLI/tables/individual-treasure-challenge-04.md)

![Individual Treasure: Challenge 5—10](/2-Mechanics/CLI/tables/individual-treasure-challenge-510.md)

![Individual Treasure: Challenge 11—16](/2-Mechanics/CLI/tables/individual-treasure-challenge-1116.md)

![Individual Treasure: Challenge 17+](/2-Mechanics/CLI/tables/individual-treasure-challenge-17.md)
...
![Treasure Hoard: Challenge 0—4](/2-Mechanics/CLI/tables/treasure-hoard-challenge-04.md)

![Treasure Hoard: Challenge 5—10](/2-Mechanics/CLI/tables/treasure-hoard-challenge-510.md)

![Treasure Hoard: Challenge 11—16](/2-Mechanics/CLI/tables/treasure-hoard-challenge-1116.md)

![Treasure Hoard: Challenge 17+](/2-Mechanics/CLI/tables/treasure-hoard-challenge-17.md)
...
![10 gp Gemstones](/2-Mechanics/CLI/tables/10-gp-gemstones.md)

![50 gp Gemstones](/2-Mechanics/CLI/tables/50-gp-gemstones.md)

![100 gp Gemstones](/2-Mechanics/CLI/tables/100-gp-gemstones.md)

![500 gp Gemstones](/2-Mechanics/CLI/tables/500-gp-gemstones.md)

![1,000 gp Gemstones](/2-Mechanics/CLI/tables/1000-gp-gemstones.md)

![5,000 gp Gemstones](/2-Mechanics/CLI/tables/5000-gp-gemstones.md)
...
![25 gp Art Objects](/2-Mechanics/CLI/tables/25-gp-art-objects.md)

![250 gp Art Objects](/2-Mechanics/CLI/tables/250-gp-art-objects.md)

![750 gp Art Objects](/2-Mechanics/CLI/tables/750-gp-art-objects.md)

![2,500 gp Art Objects](/2-Mechanics/CLI/tables/2500-gp-art-objects.md)

![7,500 gp Art Objects](/2-Mechanics/CLI/tables/7500-gp-art-objects.md)
...
![Magic Item Rarity](/2-Mechanics/CLI/tables/magic-item-rarity.md)
...
The [identify](/2-Mechanics/CLI/spells/identify.md) spell is the fastest way to reveal an item's properties. Alternatively, a character can focus on one magic item during a short rest, while being in physical contact with the item. At the end of the rest, the character learns the item's properties, as well as how to use them. Potions are an exception; a little taste is enough to tell the taster what the potion does.

Sometimes a magic item carries a clue to its properties. The command word to activate a ring might be etched in tiny letters inside it, or a feathered design might suggest that it's a [ring of feather falling](/2-Mechanics/CLI/items/ring-of-feather-falling.md).

Wearing or experimenting with an item can also offer hints about its properties. For example, if a character puts on a [ring of jumping](/2-Mechanics/CLI/items/ring-of-jumping.md), you could say, "Your steps feel strangely springy." Perhaps the character then jumps up and down to see what happens. You then say the character jumps unexpectedly high.
...
Attunement to a cursed item can't be ended voluntarily unless the curse is broken first, such as with the [remove curse](/2-Mechanics/CLI/spells/remove-curse.md) spell.
...
A wizard spell on a spell scroll can be copied just as spells in spellbooks can be copied. When a spell is copied from a spell scroll, the copier must succeed on an Intelligence ([Arcana](/2-Mechanics/CLI/rules/skills.md#Arcana)) check with a DC equal to 10 + the spell's level. If the check succeeds, the spell is successfully copied. Whether the check succeeds or fails, the spell scroll is destroyed.

![Spell Scrolls; Spell Scroll](/2-Mechanics/CLI/tables/spell-scrolls-spell-scroll.md)
...
If an item requires an action to activate, that action isn't a function of the [Use an Object](/2-Mechanics/CLI/rules/actions.md#Use%20an%20Object) action, so a feature such as the rogue's Fast Hands can't be used to activate the item.
...
The tables that follow can help you come up with answers. Roll on as many of these tables as you like. Some of the table entries make more sense for certain items than for others. Some magic items are made only by certain kinds of creatures, for instance; a [cloak of elvenkind](/2-Mechanics/CLI/items/cloak-of-elvenkind.md) is made by elves, rather than dwarves. If you roll something that doesn't make sense, roll again, choose a more appropriate entry, or use the rolled detail as inspiration to make up your own.

![Special Features; Who Created It or Was Intended to Use It?](/2-Mechanics/CLI/tables/special-features-who-created-it-or-was-intended-to-use-it.md)

![Special Features; What Is a Detail from Its History?](/2-Mechanics/CLI/tables/special-features-what-is-a-detail-from-its-history.md)

![Special Features; What Minor Property Does It Have](/2-Mechanics/CLI/tables/special-features-what-minor-property-does-it-have.md)

![Special Features; What Quirk Does It Have](/2-Mechanics/CLI/tables/special-features-what-quirk-does-it-have.md)
...
![Magic Item Table A](/2-Mechanics/CLI/tables/magic-item-table-a.md)

![Magic Item Table B](/2-Mechanics/CLI/tables/magic-item-table-b.md)

![Magic Item Table C](/2-Mechanics/CLI/tables/magic-item-table-c.md)

![Magic Item Table D](/2-Mechanics/CLI/tables/magic-item-table-d.md)

![Magic Item Table E](/2-Mechanics/CLI/tables/magic-item-table-e.md)

![Magic Item Table F](/2-Mechanics/CLI/tables/magic-item-table-f.md)

![Magic Item Table G](/2-Mechanics/CLI/tables/magic-item-table-g.md)

![Magic Item Table H](/2-Mechanics/CLI/tables/magic-item-table-h.md)

![Magic Item Table I](/2-Mechanics/CLI/tables/magic-item-table-i.md)
...
![Sentient Magic Item Communication](/2-Mechanics/CLI/tables/sentient-magic-item-communication.md)

#### Senses

With sentience comes awareness. A sentient item can perceive its surroundings out to a limited range. You can choose its senses or roll on the following table.

![Sentient Magic Item Senses](/2-Mechanics/CLI/tables/sentient-magic-item-senses.md)

#### Alignment

A sentient magic item has an alignment. Its creator or nature might suggest an alignment. If not, you can pick an alignment or roll on the following table.

![Sentient Magic Item Alignment](/2-Mechanics/CLI/tables/sentient-magic-item-alignment.md)
...
![Sentient Special Purpose](/2-Mechanics/CLI/tables/sentient-special-purpose.md)
...
- [Blackrazor](/2-Mechanics/CLI/items/blackrazor.md)  
- [Moonblade](/2-Mechanics/CLI/items/moonblade.md)  
- [Wave](/2-Mechanics/CLI/items/wave.md)  
- [Whelm](/2-Mechanics/CLI/items/whelm.md)  
...
![Artifact Properties; Minor Beneficial Properties](/2-Mechanics/CLI/tables/artifact-properties-minor-beneficial-proper