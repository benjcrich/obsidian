...
![Proficiency Dice](/2-Mechanics/CLI/tables/proficiency-dice.md)
...
![Ability Check Proficiency by Class](/2-Mechanics/CLI/tables/ability-check-proficiency-by-class.md)
...
When adventurers confront threats they have no hope of overcoming, you can call for them to make a Wisdom saving throw. Set the DC according to the circumstances. A character who fails the save becomes [frightened](/2-Mechanics/CLI/rules/conditions.md#frightened) for 1 minute. The character can repeat the saving throw at the end of each of his or her turns, ending the effect on the character on a successful save.
...
![Explosives](/2-Mechanics/CLI/tables/explosives.md)
...
![Figuring Out Alien Technology](/2-Mechanics/CLI/tables/figuring-out-alien-technology.md)
...
![Speed Factor Initiative Modifiers](/2-Mechanics/CLI/tables/speed-factor-initiative-modifiers.md)
...
- [Climb onto a Bigger Creature](/2-Mechanics/CLI/rules/actions.md#Climb%20onto%20a%20Bigger%20Creature)  
- [Disarm](/2-Mechanics/CLI/rules/actions.md#Disarm)  
- [Mark](/2-Mechanics/CLI/rules/actions.md#Mark)  
- [Overrun](/2-Mechanics/CLI/rules/actions.md#Overrun)  
- [Shove Aside](/2-Mechanics/CLI/rules/actions.md#Shove%20Aside)  
- [Tumble](/2-Mechanics/CLI/rules/actions.md#Tumble)  
...
![Lingering Injuries](/2-Mechanics/CLI/tables/lingering-injuries.md)
...
![Creating Quick Monster Stats; Monster Statistics by Challenge Rating](/2-Mechanics/CLI/tables/creating-quick-monster-stats-monster-statistics-by-challenge-rating.md)
...
![Final Challenge Rating; Experience Points by Challenge Rating](/2-Mechanics/CLI/tables/final-challenge-rating-experience-points-by-challenge-rating.md)
...
![Assign Hit Dice; Hit Dice by Size](/2-Mechanics/CLI/tables/assign-hit-dice-hit-dice-by-size.md)
...
![Damage Vulnerabilities, Resistances, and Immunities; Effective Hit Points Based on Resistances and Immunities](/2-Mechanics/CLI/tables/damage-vulnerabilities-resistances-and-immunities-effective-hit-points-based-on-resistances-and-immunities.md)
...
If you want a monster to be proficient in a skill, you can give it a bonus equal to its proficiency bonus on ability checks related to that skill. For example, a monster with sharp senses might have a bonus on Wisdom ([Perception](/2-Mechanics/CLI/rules/skills.md#Perception)) checks, while a duplicitous monster might have a bonus on Charisma ([Deception](/2-Mechanics/CLI/rules/skills.md#Deception)) checks.

You can double the proficiency bonus to account for heightened mastery. For example, a doppelganger is so good at deceiving others that its bonus on Charisma ([Deception](/2-Mechanics/CLI/rules/skills.md#Deception)) checks is equal to double its proficiency bonus + its Charisma modifier.
...
All monsters have a passive Wisdom ([Perception](/2-Mechanics/CLI/rules/skills.md#Perception)) score, which is most often used to determine whether a monster detects approaching or hidden enemies. A monster's passive Wisdom ([Perception](/2-Mechanics/CLI/rules/skills.md#Perception)) score is 10 + its Wisdom modifier. If the monster has proficiency in the Perception skill, its score is 10 + its Wisdom ([Perception](/2-Mechanics/CLI/rules/skills.md#Perception)) bonus.
...
![Creating a Monster Stat Block; Monster Features](/2-Mechanics/CLI/tables/creating-a-monster-stat-block-monster-features.md)
...
![Creating NPCs from Scratch; NPC Features](/2-Mechanics/CLI/tables/creating-npcs-from-scratch-npc-features.md)
...
![Spell Damage](/2-Mechanics/CLI/tables/spell-damage.md)
...
![Power Level; Magic Item Power by Rarity](/2-Mechanics/CLI/tables/power-level-magic-item-power-by-rarity.md)
...
Filling in the remaining details, we end up with the following [racial traits for the aasimar](/2-Mechanics/CLI/races/aasimar-dmg.md).
