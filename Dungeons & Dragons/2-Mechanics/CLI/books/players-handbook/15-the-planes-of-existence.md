...
![](/2-Mechanics/CLI/books/players-handbook/img/planes-1.webp#center)
...
A number of spells allow direct or indirect access to other planes of existence. [Plane shift](/2-Mechanics/CLI/spells/plane-shift.md) and [gate](/2-Mechanics/CLI/spells/gate.md) can transport adventurers directly to any other plane of existence, with different degrees of precision. Etherealness allows adventurers to enter the Ethereal Plane and travel from there to any of the planes it touches—the Shadowfell, the Feywild, or the Elemental Planes. And the [astral projection](/2-Mechanics/CLI/spells/astral-projection.md) spell lets adventurers project themselves into the Astral Plane and travel to the Outer Planes.
...
![Outer Planes](/2-Mechanics/CLI/tables/outer-planes.md)
...
![](/2-Mechanics/CLI/books/players-handbook/img/planes-2.webp#center)