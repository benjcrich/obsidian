...
![](/2-Mechanics/CLI/backgrounds/img/investigator.webp#right)  

- **Skill Proficiencies.** Choose two from among [Insight](/2-Mechanics/CLI/rules/skills.md#Insight), [Investigation](/2-Mechanics/CLI/rules/skills.md#Investigation), or [Perception](/2-Mechanics/CLI/rules/skills.md#Perception)  
...
- **Equipment.** A [magnifying glass](/2-Mechanics/CLI/items/magnifying-glass.md), evidence from a past case (choose one or roll for a trinket from the [Horror Trinkets](/2-Mechanics/CLI/items/horror-trinket-vrgr.md) later in this chapter), a [set of common clothes](/2-Mechanics/CLI/items/common-clothes.md), and 10 gp  
