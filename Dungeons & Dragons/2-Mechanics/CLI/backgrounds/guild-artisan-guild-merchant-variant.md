...
- **Tool Proficiencies.** One type of artisan's tools, or [navigator's tools](/2-Mechanics/CLI/items/navigators-tools.md), or an additional language  
- **Languages.** One of your choice  
- **Equipment.** A set of artisan's tools (one of your choice) or a [mule](/2-Mechanics/CLI/items/mule.md) and [cart](/2-Mechanics/CLI/items/cart.md), a letter of introduction from your guild, a set of [traveler's clothes](/2-Mechanics/CLI/items/travelers-clothes.md), and a belt [pouch](/2-Mechanics/CLI/items/pouch.md) containing 15 gp  
